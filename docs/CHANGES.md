...
## v0.5 · Phase 5
- Analyse-Coach mit konkretem nächstem Schritt und Direktnavigation ergänzt
- lokale Sofortauswertung nach Dokument- oder Fallanalyse ergänzt, inklusive Hauptlinie, Soll-Hinweisen, Hotspots und Datenlücken
- Guided-Einstieg im Beobachtungs-Schritt verständlicher gemacht
- Discovery, Soll-Abgleich und Verbesserungsanalyse laufen beim Öffnen jetzt automatisch lokal an, wenn genug Material vorliegt
- bessere Rückmeldung nach Freitext-Erkennung im Intake-Panel
