## v0.40.1 · Qualitätscheck-Export für manuelle Referenzläufe

- die bisherige Skriptidee wurde zurückgenommen und durch eine sichtbare Exportfunktion direkt in der App ersetzt
- neuer Bereich in Schritt 5: **Qualitätscheck als JSON exportieren**
- Export enthält den aktuellen PM-Arbeitsstand, Qualitätsmetriken, Reifeindikatoren und die komplette lokale Analysekette
- sichtbare Knöpfe für **JSON exportieren** und **JSON kopieren**
- gedacht für manuelle Referenzläufe: Dokument oder Testfall durch die App laufen lassen, dann JSON exportieren und zur Auswertung hochladen
