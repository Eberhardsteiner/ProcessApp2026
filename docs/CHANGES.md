...
- UI-Konsolidierung und ruhigerer Arbeitsfluss, danach lokale Analyseengine 3.0, Prüfwerkstatt 2.0 und technische Härtung für den Pilotbetrieb
...
## v0.17 · Phase 17 · Berichte, Exporte und Vergleichbarkeit

### Schwerpunkt
Die Berichtsstufe wurde professioneller gemacht, ohne die Oberfläche zu überladen. Berichte erklären jetzt ihre Grundlage besser, lassen sich strukturierter exportieren und mit dem letzten Bericht vergleichen.

### Wichtige Änderungen
- Berichtsgrundlage direkt im UI sichtbar: Quellen, Schritte, Belegstellen, Soll-Hinweise, Hotspots und Datenreife
- Vergleich zum letzten Bericht mit verständlicher Veränderungsbeschreibung
- lokales Berichtspaket als Markdown, Übergabepaket als Text und strukturierter JSON-Export
- Berichte können direkt als Evidenz gemerkt werden
- Berichtshistorie je Arbeitsstand, damit Vergleiche zwischen Berichtsständen möglich bleiben
- neue Hilfetexte für Berichtsgrundlage, Vergleich und Export

### Ergebnis
- lokale Berichtsstufe besser für Management, Prozessverantwortung und strukturierte Weitergabe nutzbar
- Vergleichbarkeit zwischen Analysezuständen steigt, ohne auf externe Dienste angewiesen zu sein
- Übersichtlichkeit bleibt erhalten, weil Export und Vergleich als klar getrennte Blöcke eingebettet wurden
