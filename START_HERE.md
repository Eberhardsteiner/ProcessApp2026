...
Öffnen Sie im Assisted Process Mining Schritt 5 den Bereich **"Qualitätscheck als JSON exportieren"**.
Dort finden Sie den sichtbaren Exportknopf für den aktuellen Referenzlauf.
