...
export const NEXT_PHASES: RoadmapPhase[] = [
  {
    phase: 'Nächster Schwerpunkt',
    title: 'Feinschliff nach Testfeedback',
    summary: 'Weitere Optimierungen folgen gezielt aus Ihrem Praxistest, vor allem bei Bedienlogik, Exporttiefe und Performance.',
  },
];
