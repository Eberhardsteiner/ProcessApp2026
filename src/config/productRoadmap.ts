...
export const NEXT_PHASES: RoadmapPhase[] = [
  {
    ...
    summary: 'Große Dateien zerlegen, Bundles verkleinern und die Reaktionszeit bei größeren Materialien verbessern.',
  },
  {
    phase: 'Phase 20',
    title: 'Mehr Goldfälle und Domänenpakete',
    summary: 'Weitere Referenzfälle, Fachpakete und robustere Heuristiken sollen die lokale Analyse ohne KI weiter absichern.',
  },
];
