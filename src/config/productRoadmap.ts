...
export const COMPLETED_PHASES: RoadmapPhase[] = [
  ...
  },
  {
    versionLabel: 'v0.32',
    phase: 'Phase 32',
    title: 'Produkt-Härtung und Fehlerabbau',
    summary: 'Arbeitsstände werden jetzt beim Laden und Wiederherstellen automatisch stabilisiert, Save-Fehler klar geführt und Release-Checks um echte Recovery-Szenarien erweitert.',
  },
  {
    versionLabel: 'v0.33',
    phase: 'Phase 33',
    title: 'UI-Konsolidierung und Bedienlogik',
    summary: 'Schrittführung, Status, Schnellzugriff, Aktionsleisten und Schrittköpfe folgen jetzt einem ruhigeren, einheitlicheren Muster. Der Assisted-PM-Bereich wirkt dadurch konsistenter und leichter bedienbar.',
  },
  {
    versionLabel: 'v0.34',
    phase: 'Phase 34',
    title: 'Lokale Analyseengine 4.0',
    summary: 'Feinere Materialklassifikation, sauberere Trennung von Prozesskern und Kontext sowie ein erklärbarer lokaler Ableitungsplan machen die Onboard-Analyse ohne KI präziser und nachvollziehbarer.',
  },
  {
    versionLabel: 'v0.35',
    phase: 'Phase 35',
    title: 'Domänenbibliothek 2.0 und Qualitätsmetriken',
    summary: 'Rechnungsklärung und Stammdatenänderungen sind jetzt gemessene Fachpakete. Die Domänenbibliothek zeigt zusätzlich Score, Benchmark-Basis sowie starke und schwächere Qualitätsdimensionen je Fachfeld.',
  },
  {
    versionLabel: 'v0.36',
    phase: 'Phase 36',
    title: 'Zusammenarbeit, Kommentare und Auditierbarkeit',
    summary: 'Kommentare, Team-Notizen und eine ruhige Auditspur machen Review, Freigabe und Zusammenarbeit nachvollziehbarer, ohne den Hauptfluss zu überladen.',
  },
  {
    versionLabel: 'v0.37',
    phase: 'Phase 37',
    title: 'Reale Integrationsschicht',
    summary: 'Connector-Wege werden jetzt durch strukturierte Verträge, Exchange Packages und kontrolliert übernommene Rückmeldungen zu belastbareren Integrationspfaden weitergeführt.',
  },
  {
    versionLabel: 'v0.38',
    phase: 'Phase 38',
    title: 'Sicherheit, Datenschutz und Deployment-Reife',
    summary: 'Sicherheitsprofil, Datenklassifikation, Aufbewahrung, Deployment-Ziel und ein lokaler Security-Check fassen den verantwortbaren Betriebsrahmen jetzt sichtbar und exportierbar zusammen.',
  },
  {
    versionLabel: 'v0.39',
    phase: 'Phase 39',
    title: 'Pilotbetrieb 3.0 und formale Abnahme',
    summary: 'Eine formale Abnahmehilfe bündelt jetzt Entscheidung, Checkliste, Pilotstatus und exportierbare Vorlagen. Acceptance-Check und Release-Check schließen den aktuellen Kernplan kontrolliert ab.',
  },
  {
    versionLabel: 'v0.40',
  ...
  {
    versionLabel: 'v0.43',
    phase: 'Sanierungsstufen A–E',
    title: 'Router, Tabellenpfad und Mischdokumente nachgeschärft',
    summary: 'Dokumente bleiben jetzt verlässlicher im passenden Analysepfad, Tabellen- und Eventlogquellen werden defensiver und sauberer interpretiert, Export-Integrität ist abgesichert und Mischdokumente führen Prozesskern, Review- und Governance-Signale getrennt.',
  },
