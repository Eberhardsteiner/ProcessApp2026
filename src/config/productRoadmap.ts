...
export const COMPLETED_PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    summary: 'Fachpakete erkennen Pflichtlücken, Eskalationsdruck, Systemsuche, Koordinationsaufwand und weitere Muster jetzt direkt lokal ohne KI.',
  },
];
...
export const NEXT_PHASES: RoadmapPhase[] = [
  ...
  {
    phase: 'Phase 13',
    title: 'Feinschliff für Navigation und Geschwindigkeit',
    summary: 'Weitere UI-Bereinigung, schnellere Arbeitswege und technische Entlastung großer Komponenten.',
  },
];
