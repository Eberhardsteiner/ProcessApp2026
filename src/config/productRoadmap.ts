...
export const COMPLETED_PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    summary: 'Berichte zeigen jetzt ihre Grundlage klarer, strukturierte Exportpakete stehen lokal bereit und der Vergleich zum letzten Bericht macht Veränderungen im Analysezustand sofort sichtbar.',
  },
];
...
export const NEXT_PHASES: RoadmapPhase[] = [
  ...
  {
    phase: 'Phase 19',
    title: 'Pilotpakete und branchennahe Starter',
    summary: 'Geführte Starterpakete, bessere Beispieldaten und branchenspezifische Onboarding-Pfade machen die App schneller pilotfähig.',
  },
];
