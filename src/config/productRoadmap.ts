...
export const NEXT_PHASES: RoadmapPhase[] = [
  {
    ...
    summary: 'Strukturiertere Exportpakete, Governance-Ansichten und ein klareres Toolkit für Workshops und Pilottermine runden den Einsatz ab.',
  },
  {
    phase: 'Phase 26',
    title: 'Betriebsreife und optionale Integrationen',
    summary: 'Stabilere Connector-Wege, robuste Importpfade und klarere Betriebsgrenzen sollen die App für längere Test- und Pilotläufe absichern.',
  },
  {
    phase: 'Phase 27',
    title: 'Feinschliff für Freigabe- und Review-Prozesse',
    summary: 'Vergleichbare Governance-Stände, feinere Review-Vorlagen und klarere Übergänge zwischen Analyse, Review und Freigabe sollen die Teamarbeit weiter beruhigen.',
  },
  {
    phase: 'Phase 28',
    title: 'Domänenbibliothek und optionale Integrationen',
    summary: 'Weitere Fachpakete, Connector-Vorlagen und robuste Übergabepfade sollen den produktiven Einsatz schrittweise verbreitern, ohne die App zu überladen.',
  },
];
