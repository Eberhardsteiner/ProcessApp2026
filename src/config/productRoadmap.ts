...
export const COMPLETED_PHASES: RoadmapPhase[] = [
  ...
  {
    versionLabel: 'v0.40.1',
    phase: 'Korrektur-Release',
    title: 'Qualitätscheck-Export für manuelle Referenzläufe',
    summary: 'Statt einer versteckten Skriptlösung gibt es jetzt eine sichtbare Exportfunktion direkt in Schritt 5. Sie erzeugt ein JSON des aktuellen Analysezustands, nachdem ein Referenzdokument oder Testlauf durch die App gelaufen ist.',
  },
