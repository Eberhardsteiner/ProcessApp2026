...
export const HELP_TEXTS = {
  ...
  'pmv2.domain': {
    ...
    body:
      'Die App nutzt hier lokale Domänenregeln, um typische Muster wie Pflichtlücken, Eskalationsdruck, Koordinationsaufwand oder Freigaben zu erkennen.\n' +
      'So entstehen bereits ohne KI konkrete Hinweise, die fachlich näher an der Praxis liegen.',
  },
  'pmv2.quality': {
    title: 'Datenstärke',
    body:
