...
export const HELP_TEXTS = {
  ...
  'pmv2.benchmark': {
    ...
    body:
      ...
      'Damit werden grobe Rückschritte früh sichtbar, auch wenn noch keine KI genutzt wird.',
  },
  'pmv2.details': {
  ...
  'pmv2.reportCompare': {
    title: 'Berichtsgrundlage und Vergleich',
    body:
      'Zeigt, worauf der aktuelle Bericht basiert: Anzahl der Quellen, erkannte Schritte, Soll-Hinweise, Hotspots und Datenreife.\n' +
      'Wenn schon ein früherer Bericht vorliegt, sehen Sie hier auch, was sich seitdem wesentlich verändert hat.',
  },
  'pmv2.reportExport': {
    title: 'Export und Weitergabe',
    body:
      'Das Berichtspaket bündelt Management-Kurzfassung, Prozessgeschichte, Befunde, nächste Schritte und Übergabetexte.\n' +
      'JSON eignet sich für strukturierte Weiterverarbeitung, Markdown und Text für direkte Weitergabe oder Dokumentation.',
  },
  'pmv2.story': {
