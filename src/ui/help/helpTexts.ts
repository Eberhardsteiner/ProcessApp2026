...
export const HELP_TEXTS = {
  ...
  'pmv2.flow': {
    title: 'Status der Arbeitsschritte',
    body:
      'Zeigt, welcher Schritt bereits erledigt ist, was aktuell bearbeitet wird und was noch auf Daten oder Vorarbeit wartet.\n' +
      'So vermeiden Sie Sackgassen und sehen sofort, welcher nächste Schritt wirklich sinnvoll ist.',
  },
  'pmv2.consistency': {
    title: 'Konsistenzschutz',
    body:
      'Wenn sich Quellen, erkannte Schritte oder die Hauptlinie ändern, setzt die App nachgelagerte Auswertungen und Berichte automatisch zurück.\n' +
      'Dadurch bleiben keine veralteten Ergebnisse stehen, die zur neuen Datenbasis nicht mehr passen.',
  },
  'pmv2.samples': {
    title: 'Beispielpakete',
    body:
      'Die Beispielpakete laden lokale Testfälle direkt in den Assisted-Process-Mining-Arbeitsstand.\n' +
      'Neu sind breitere Fachpakete für Reklamationen, Service, Retouren, Einkauf und Onboarding. Das ist hilfreich für Onboarding, Demos und einen schnellen Funktionscheck ohne eigenes Material.',
  },
  'pmv2.domainLibrary': {
    title: 'Domänenbibliothek',
    body:
      'Die Domänenbibliothek zeigt, welche Fachpakete lokal ohne KI bereits gut abgedeckt sind und wie belastbar die Qualitätsdimensionen je Fachfeld aktuell wirken.\n' +
      'Gemessene Pakete hängen am Benchmark und zeigen jetzt zusätzlich Score, Goldfälle, Beispielpakete sowie starke und schwächere Qualitätsdimensionen. Vorschau-Pakete bleiben bewusst explorativ.',
  },
  'pmv2.workspace': {
  ...
  'pmv2.operatingMode': {
    title: 'Betriebsmodus',
    body:
      'Der Betriebsmodus steuert, wie viel Tiefe die App standardmäßig zeigt.\n' +
      'Kurztest hält die Oberfläche bewusst knapp. Standard ist der ausgewogene Normalweg. Pilotlauf öffnet mehr Qualitäts-, Beleg- und Benchmark-Sichten für längere Tests und nachvollziehbare Übergaben.',
  },
  'pmv2.readiness': {
    title: 'Analyse-Reife',
    body:
  ...
  'pmv2.evidence': {
    ...
    body:
      'Der Beleg-Inspektor zeigt an einem einzelnen Schritt, auf welche Textstelle sich die App stützt und wie der Schritt eingeordnet wurde.\n' +
      'So wird die lokale Analyse nachvollziehbarer und Sie sehen schneller, wo noch Nachschärfung sinnvoll ist.',
  },
  'pmv2.evidenceInspector': {
    title: 'Beleg-Inspektor',
    body:
      'Hier sehen Sie, warum die App einen Schritt oder ein Reibungssignal erkannt hat.\n' +
      'Belegstellen, Rollen, Systeme und Zeitangaben machen die lokale Ableitung nachvollziehbar.',
  },
  'pmv2.benchmark': {
    title: 'Goldfälle und Regression',
    body:
      'Goldfälle sind feste Referenzbeispiele, mit denen die lokale Analyseengine regelmäßig geprüft wird.\n' +
      'Neu sind breitere Fachfelder wie Rechnungsklärung und Stammdatenänderungen, gespeicherte Benchmark-Verläufe, Domänenmetriken, Qualitätsdimensionen und ein strenger Qualitätscheck. So wird schneller sichtbar, ob eine lokale Verbesserung wirklich breit trägt.',
  },
  'pmv2.details': {
    title: 'Detailbearbeitung',
    body:
      'Die Detailkarten sind bewusst optional.\n' +
      'Nutzen Sie sie nur dann, wenn eine einzelne Quelle, Metadaten oder erkannte Schritte gezielt nachgeschärft werden sollen.',
  },
  'pmv2.review': {
    title: 'Prüfwerkstatt',
    body:
      'Hier schärfen Sie die lokale Ableitung ohne KI.\n' +
      'Neu sind Mehrfachauswahl, sichere Rückgängig-/Wiederholen-Schritte und gemerkte Vereinheitlichungsregeln für Begriffe, Rollen und Systeme.',
  },
  'pmv2.discovery': {
  ...
  'pmv2.governance': {
    ...
    body:
      'Hier sammeln Sie Entscheidungslog, Review-Checkliste, gemerkte Governance-Stände und den Freigabepfad an einem Ort.\n' +
      'So bleibt nachvollziehbar, was vor Review, Pilot oder Weitergabe noch geprüft, freigegeben oder bewusst zurückgestellt wurde und wie sich der Governance-Stand seit dem letzten Review verändert hat.',
  },
  'pmv2.governanceInsights': {
    title: 'Freigabe-Assistenz und Governance-Auswertung',
    body:
      'Dieser Bereich verdichtet Governance-Reife, offene Entscheidungen, Review-Dauer und Freigabezustand zu einer ruhigen Steuerungssicht.\n' +
      'Sie sehen dadurch schneller, welche Punkte wirklich priorisiert werden sollten, ob eine Freigabe noch zur Analysebasis passt und welche nächste Aktion den Freigabepfad am stärksten stabilisiert.',
  },
  'pmv2.collaboration': {
    title: 'Zusammenarbeit und Auditspur',
    body:
      'Hier halten Sie kurze Team-Kommentare, Review-Notizen und nachvollziehbare Änderungen direkt am PM-Arbeitsstand fest.\n' +
      'So bleibt sichtbar, wer was angemerkt, geprüft oder freigegeben hat, ohne auf externe Listen oder E-Mail-Ketten ausweichen zu müssen.',
  },
  'pmv2.ai': {
  ...
  'pmv2.pilot': {
    ...
    body:
      'Diese Karte bündelt die wichtigsten Kriterien für einen begleiteten Pilotlauf.\n' +
      'Sie zeigt nicht nur, wie weit der Arbeitsstand ist, sondern auch, welche nächsten Schritte den Pilot am zuverlässigsten vorbereiten.',
  },
  'pmv2.hardening': {
    title: 'Arbeitsstand-Härtung',
    body:
      'Diese Karte prüft den aktuellen PM-Arbeitsstand auf beschädigte, veraltete oder widersprüchliche Zustände.\n' +
      'Kleinere Brüche werden automatisch repariert, damit Quellen, Analysekette, Bericht und Übergaben auf einer sauberen Basis weiterlaufen.',
  },
  'pmv2.snapshot': {
    title: 'Arbeitsstand sichern und wiederherstellen',
    body:
      'Hier sichern Sie den vollständigen Assisted-Process-Mining-Arbeitsstand als JSON oder laden ihn später wieder ein.\n' +
      'Das ist besonders hilfreich vor Pilotterminen, bei Übergaben und vor größeren Änderungen am Arbeitsstand.',
  },
  'pmv2.qualityExport': {
    title: 'Qualitätscheck als JSON exportieren',
    body:
      'Dieser Export ist für manuelle Referenzläufe gedacht. Nachdem Sie ein Testdokument oder einen Testfall durch die App haben laufen lassen, erzeugt die App hier eine JSON-Datei mit Arbeitsstand, Qualitätsmetriken und Analysekette.\n' +
      'Diese Datei können Sie anschließend hochladen, damit die Analysequalität der App im Detail bewertet werden kann.',
  },
  'pmv2.pilotToolkit': {
    title: 'Pilot-Toolkit und Exportpakete',
    body:
      'Dieses Toolkit bündelt Bericht, Übergaben, Governance-Review und den aktuellen PM-Arbeitsstand in einer ruhigen Exportform.\n' +
      'Damit lassen sich Pilottermine, Workshops und Review-Runden besser vorbereiten, ohne dass Sie Inhalte aus mehreren Bereichen zusammensuchen müssen.',
  },
  'pmv2.acceptance': {
    title: 'Pilotbetrieb 3.0 und formale Abnahme',
    body:
      'Hier verdichtet die App den Stand zu einer formalen Entscheidungsvorlage.\n' +
      'Sie sehen, ob Benchmark, Bericht, Governance, Sicherheit, Pilotpaket und eine kurze Checkliste gemeinsam schon für Pilot, begrenzte Freigabe oder weitere Nachschärfung tragen.',
  },
  'pmv2.releaseFlow': {
    title: 'Freigabe und Stabilisierung',
    body:
      'Diese Karte führt den letzten Schritt in einer ruhigen Reihenfolge zusammen: erst Bericht, dann Review und Freigabe, danach Pilot-Paket und nur bei Bedarf optionale Connector-Pakete.\n' +
      'So bleibt sichtbar, was für einen belastbaren Pilot- oder Freigabestand noch fehlt und welche Bereiche bereits stabil sind.',
  },
  'pmv2.importHealth': {
    title: 'Import-Gesundheit',
    body:
      'Diese Karte prüft, wie tragfähig die bisherigen Importwege wirklich sind.\n' +
      'Sie zeigt, welche Quellen bereits gute Prozessschritte liefern, wo Belegstellen oder Zeitangaben noch schwach sind und welcher nächste Reparaturschritt den lokalen Arbeitsstand am stärksten verbessert.',
  },
  'pmv2.integration': {
    title: 'Betriebsgrenzen und optionale Integrationen',
    body:
      'Hier wird klar getrennt, was die App aktuell schon belastbar leisten kann, was nur mit Vorsicht gelesen werden sollte und welche Integrationswege bewusst noch optional bleiben.\n' +
      'Statt stiller Live-Kopplungen zeigt die App vorbereitete Exportprofile, Copy/Paste-Wege und optional konfigurierbare API-Pfade.',
  },
  'pmv2.connectorBundles': {
    title: 'Connector-Pakete und Betriebshilfen',
    body:
      'Dieser Bereich bündelt vorbereitete Exportpakete für Ticket-Handover, BI, KI-/API-Proxy und Governance.\n' +
      'Die Pakete bleiben bewusst optional: Sie liefern strukturierte JSON- und Textvorlagen, ohne den lokalen Kern oder den aktuellen Arbeitsstand still im Hintergrund zu synchronisieren.',
  },
  'pmv2.integrationAdapters': {
    title: 'Integrationswerkbank',
    body:
      'Hier werden aus den Connector-Paketen klarere Verträge und kontrollierte Übergabepfade.\n' +
      'Sie sehen, welche Pflichtfelder bereits gefüllt sind, können ein Exchange Package erzeugen und externe Rückmeldungen strukturiert in den Arbeitsstand zurückholen, ohne eine stille Live-Kopplung zu aktivieren.',
  },
  'pmv2.security': {
    title: 'Sicherheit, Datenschutz und Deployment',
    body:
      'Dieser Bereich fasst den verantwortbaren Betriebsrahmen der App zusammen: Datenklassifikation, externe Wege, Aufbewahrung, Backups, Deployment-Ziel und Ansprechpersonen.\n' +
      'Die App entscheidet hier nichts automatisch, sondern macht den Rahmen sichtbar und exportierbar, damit Pilot, Datenschutz und IT denselben Stand sehen.',
  },
