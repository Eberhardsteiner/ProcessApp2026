...
export const HELP_TEXTS = {
  ...
  'pmv2.governance': {
    ...
    body:
      'Hier sammeln Sie Entscheidungslog, Review-Checkliste und Teamabstimmung an einem Ort.\n' +
      'So bleibt nachvollziehbar, was vor Review, Pilot oder Weitergabe noch geprüft, freigegeben oder bewusst zurückgestellt wurde.',
  },
  'pmv2.ai': {
