...
export const HELP_TEXTS = {
  ...
  'pmv2.domainLibrary': {
    ...
    body:
      'Die Domänenbibliothek zeigt, welche Fachpakete lokal ohne KI bereits gut abgedeckt sind und welche als Vorschau bereitstehen.\n' +
  ...
  'pmv2.benchmark': {
    ...
    body:
      ...
      'Neu sind breitere Fachfelder wie Einkauf und Onboarding, gespeicherte Benchmark-Verläufe, Qualitätsdimensionen und ein strenger Qualitätscheck. So wird schneller sichtbar, ob eine lokale Verbesserung wirklich breit trägt.',
  },
  'pmv2.details': {
