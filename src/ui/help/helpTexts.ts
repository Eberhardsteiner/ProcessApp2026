...
export const HELP_TEXTS = {
  ...
  'pmv2.samples': {
    ...
    body:
      ...
      'Das ist hilfreich für Onboarding, Demos und einen schnellen Funktionscheck ohne eigenes Material.',
  },
  'pmv2.workspace': {
  ...
  'pmv2.benchmark': {
    ...
    body:
      ...
      'Neu sind gespeicherte Benchmark-Verläufe, Fachfeld-Scores, Qualitätsdimensionen und ein strenger Qualitätscheck. So wird schneller sichtbar, ob eine lokale Verbesserung wirklich breit trägt.',
  },
  'pmv2.details': {
