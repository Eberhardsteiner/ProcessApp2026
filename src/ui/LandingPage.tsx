      ...
      <div className="landing-content-wrapper">
        <div className="landing-card">
          ...
          <div className="mt-4 flex items-center justify-center gap-2 text-sm text-slate-500">
            <span className="px-2 py-0.5 rounded-full bg-slate-100 border border-slate-200 font-medium text-slate-700">{APP_VERSION_LABEL}</span>
            <span>{APP_RELEASE_TITLE}</span>
          </div>
