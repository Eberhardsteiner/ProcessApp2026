...
export function InfoPopover({ title, children, ariaLabel = 'Weitere Informationen' }: InfoPopoverProps) {
  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="w-6 h-6 rounded-full border border-slate-300 hover:border-slate-400 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors inline-flex items-center justify-center"
      >
