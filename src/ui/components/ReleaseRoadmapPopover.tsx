        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            {NEXT_PHASES.length > 0 ? (
              ...
              <li className="rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-3 text-sm text-emerald-900">
                Die aktuell geplante Roadmap ist mit Phase 39 abgeschlossen. Weitere Schritte wären nur noch optionale Anschlussphasen.
              </li>
            )}
          </ul>
        </div>
