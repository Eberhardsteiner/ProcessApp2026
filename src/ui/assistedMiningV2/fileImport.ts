...
const EVENT_LOG_HEADER_HINTS = [
  'case', 'case id', 'caseid', 'case_hint', 'fall', 'fall id', 'ticket', 'vorgang',
  'activity', 'aktivität', 'aktion', 'step', 'schritt',
  'timestamp', 'datum', 'zeit', 'time', 'date', 'date_hint',
];
...
export function detectCsvImportMode(
  ...
  if (routingContext.routingClass === 'weak-raw-table') return 'narrative';
...
export function detectColumnCandidates(
  ...
  return {
    ...
    id: find(['case id', 'caseid', 'case_hint', 'fall id', 'fallid', 'ticket', 'vorgang id', 'id', 'nr', 'nummer']),
    timestamp: find(['timestamp', 'date_hint', 'datum', 'date', 'zeit', 'time', 'erstellt', 'created']),
    activity: find(['activity', 'aktivität', 'aktion', 'step', 'schritt', 'vorgang', 'ereignis', 'event']),
    caseId: find(['case id', 'caseid', 'case_hint', 'fall id', 'fallid', 'ticket', 'vorgang id', 'id']),
    role: find(['role', 'rolle', 'user', 'nutzer', 'resource', 'ressource', 'bearbeiter', 'agent']),
    system: find(['system_hint', 'system', 'tool', 'application', 'anwendung']),
  };
}
