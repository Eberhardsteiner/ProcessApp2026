...
export function toBenchmarkSnapshot(result: BenchmarkSuiteResult): ProcessMiningBenchmarkSnapshot {
  return {
    ...
    domainScores: result.domainScores.map(item => ({
      ...
      label: item.label,
      count: item.count,
      goldCaseCount: item.goldCaseCount,
      samplePackCount: item.samplePackCount,
      score: item.score,
      status: item.status,
      highlight: item.highlight,
      strongestDimensionKey: item.strongestDimension?.key,
      strongestDimensionLabel: item.strongestDimension?.label,
      strongestDimensionScore: item.strongestDimension?.score,
      weakestDimensionKey: item.weakestDimension?.key,
      weakestDimensionLabel: item.weakestDimension?.label,
      weakestDimensionScore: item.weakestDimension?.score,
      dimensionScores: item.dimensionScores.map(dimension => ({
        key: dimension.key,
