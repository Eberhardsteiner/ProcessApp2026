...
const SAMPLE_SCENARIOS: SampleScenarioDefinition[] = [
  ...
  {
    key: 'billing',
    label: 'Beispielpaket Rechnung & Zahlungsklärung',
    summary: 'Drei kurze Klärfälle mit Rechnungsprüfung, Bestellbezug, Gutschrift und Zahlungsfreigabe.',
    sources: [
      {
        name: 'Klärfall Rechnung A',
        text:
          '08:10 Eine Rechnung wird vom Kunden wegen einer Positionsabweichung beanstandet. Finanzbuchhaltung legt den Klärfall an, prüft ERP, Bestellung und Lieferschein, fordert den fehlenden Bestellbezug nach, stimmt mit Vertrieb und Fachbereich die Differenz ab, holt die Freigabe für eine Gutschrift ein, stößt den Rechnungsworkflow an und informiert Kunde und Buchhaltung über die Korrektur.',
      },
      {
        name: 'Klärfall Rechnung B',
        text:
          '10:05 Eine Zahlung wird vorläufig gesperrt, weil Rechnungsnummer und Wareneingang nicht sauber zusammenpassen. Debitorenbuchhaltung prüft den Beleg, gleicht ERP und Rechnungsworkflow ab, klärt mit Einkauf und Fachbereich den Bezug, entscheidet mit Teamleitung über Freigabe oder Gutschrift und dokumentiert die Zahlungsklärung für Kunde, Buchhaltung und Vertrieb.',
      },
      {
        name: 'Klärfall Rechnung C',
        text:
          '14:25 Für einen strategisch wichtigen Kunden muss eine Rechnungsdifferenz noch am selben Tag bereinigt werden. Finanzteam sammelt fehlende Nachweise, prüft Preis, Menge und Bestellung, stimmt sich mit Vertrieb, Fachbereich und Buchhaltung ab, gibt die Korrektur frei und bestätigt dem Kunden die Zahlungs- oder Gutschriftlösung per E-Mail.',
      },
    ],
  },
  {
    key: 'masterdata',
    label: 'Beispielpaket Stammdaten & Änderungen',
    summary: 'Drei kurze Änderungsfälle mit Validierung, Dublettenprüfung, Freigabe und Systemnachlauf.',
    sources: [
      {
        name: 'Stammdatenfall A',
        text:
          '07:40 Ein Fachbereich meldet eine Änderung an Debitorenstammdaten. Stammdatenmanagement legt den Änderungsantrag an, prüft Pflichtfelder und Nachweise, gleicht den bestehenden SAP-Satz mit dem MDM-System ab, klärt mit Compliance eine Bankdatenänderung, holt die Freigabe ein, pflegt die Änderung in ERP und bestätigt den Nachlauf an Fachbereich und Buchhaltung.',
      },
      {
        name: 'Stammdatenfall B',
        text:
          '09:55 Ein Lieferant meldet neue Kontaktdaten und eine geänderte Rechnungsadresse. Das Team prüft den Änderungswunsch, erkennt eine mögliche Dublette, gleicht SAP und das Workflow-Ticket ab, fordert einen fehlenden Nachweis an, lässt die Änderung von Einkauf und Stammdatenverantwortung freigeben und informiert danach Einkauf, Buchhaltung und Lieferant über den aktualisierten Stand.',
      },
      {
        name: 'Stammdatenfall C',
        text:
          '13:30 Für einen kurzfristigen Produktionsanlauf müssen Material- und Kundendaten noch am selben Tag korrigiert werden. Fachbereich, Stammdatenmanagement und IT prüfen die Felder, klären Konflikte zwischen ERP und MDM, holen eine Ausnahmefreigabe ein, aktualisieren die Systeme und dokumentieren offen gebliebene Nacharbeiten für den nächsten Review.',
      },
    ],
  },
];
