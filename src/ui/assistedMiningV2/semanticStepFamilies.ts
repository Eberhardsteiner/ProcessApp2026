...
export const STEP_FAMILIES: StepFamilyDefinition[] = [
  ...
  {
    id: 'context_assembly',
    label: 'Kontext und Unterlagen zusammenführen',
    patterns: [
      /\bunterlagen\b/i,
      /\bbeleg(?:e|lage)?\b/i,
      /\bdokument(?:e|ation)?\b/i,
      /\blieferschein\b/i,
      /\bkontext\b/i,
      /\bhistorie\b/i,
      /\bkundendaten\b/i,
  ...
  {
    id: 'approval',
    label: 'Freigabe und Entscheidung abstimmen',
    patterns: [
      /\bkulanz\b/i,
      /\bausnahmefreigabe\b/i,
      /\bkostenfreigabe\b/i,
      /\bteamleitung\b.*\bfreig/i,
      /\bvertrieb\b.*\bfreig/i,
      /\bgenehmig/i,
  ...
  },
  {
    ...
    patterns: [
      /\bdokumentier(?:en|ung|t)\b.*\b(absch|status|fall|ursache|wissen)\b/i,
      /\bstatus\b.*\bdokument/i,
  ...
  },
  {
    ...
    patterns: [
      /\b(st[öo]rung|incident|fehlercode)\b.*\bticket\b/i,
      /\bticket\b.*\b(st[öo]rung|incident|fehlercode)\b/i,
      /\bmeld(?:ete|ung)\b.*\bfehlercode\b/i,
      /\bfehlercode\b.*\bmeld(?:ete|ung)\b/i,
  ...
  },
  {
    ...
    patterns: [
      /\bfachbereichsfreigabe\b/i,
      /\bfreigabe\b.*\bfachbereich\b/i,
