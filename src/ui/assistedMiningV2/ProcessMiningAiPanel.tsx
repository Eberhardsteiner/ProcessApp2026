    ...
    <div className="border border-violet-200 rounded-2xl p-5 bg-violet-50/40 space-y-5">
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          Die lokale Engine bleibt führend. Die KI hilft optional dabei, Schrittlabels, Rollen, Systeme und
          Reibungssignale präziser zu formulieren. Sie können entweder mit einem vorbereiteten Prompt arbeiten oder,
          wenn im Setup aktiviert, denselben Prompt direkt per API senden.
        </p>
      </div>
