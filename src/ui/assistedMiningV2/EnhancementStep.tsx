    ...
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
        ...
        <div className="text-sm text-blue-800 space-y-1">
          <div className="flex items-center gap-2"><p className="font-medium">Was passiert hier?</p><HelpPopover helpKey="pmv2.enhancement" ariaLabel="Hilfe: Verbesserungen erkennen" /></div>
          <p>
