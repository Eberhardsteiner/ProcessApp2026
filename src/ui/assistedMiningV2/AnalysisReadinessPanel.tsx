import { Activity, AlertTriangle, CheckCircle2, Compass, Sparkles } from 'lucide-react';
...
export function AnalysisReadinessPanel({ state, version }: Props) {
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2 text-slate-700">
            ...
            <HelpPopover helpKey="pmv2.readiness" ariaLabel="Hilfe: Analyse-Reife" />
          </div>
