...
import { getBenchmarkCoverageSummary, runBenchmarkSuite, type BenchmarkCaseResult, type BenchmarkSuiteResult } from './benchmarkLab';
      ...
      <div className="grid gap-3 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-3">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            Die Bibliothek wächst jetzt bewusst über mehrere Fachfelder. So sehen wir schneller, ob lokale Verbesserungen breit tragen oder nur einen Einzelfall schöner machen.
          </p>
        </div>
