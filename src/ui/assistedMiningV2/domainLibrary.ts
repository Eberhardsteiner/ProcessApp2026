...
const DOMAIN_LIBRARY: DomainLibraryEntry[] = [
  ...
  },
  {
    ...
    note: 'Neues Explorationspaket. Noch nicht im harten Benchmark, aber lokal nutzbar.',
  },
  {
    key: 'masterdata',
    ...
    note: 'Neues Explorationspaket für typische Änderungs- und Stammdatenprozesse.',
  },
];
