...
import { QualityCheckExportPanel } from './QualityCheckExportPanel';
...
export function AugmentationStep({
  ...
  const qualityExportRef = useRef<HTMLDivElement>(null);
    ...
    <div className="space-y-6">
      ...
      <StepQuickJumpBar
        ...
        items={[
          ...
          { id: 'quality-export', label: 'Qualitätscheck JSON', hint: 'Export für Referenzläufe und Detailbewertung', onClick: () => scrollToSection(qualityExportRef) },
      ...
      <div ref={qualityExportRef}>
        <QualityCheckExportPanel
          process={process}
          version={version}
          state={state}
          settings={settings}
