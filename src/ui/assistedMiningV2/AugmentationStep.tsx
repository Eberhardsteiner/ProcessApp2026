...
import { buildProcessMiningReport, mergeReportHistory } from './reporting';
...
export function AugmentationStep({
  ...
  function handleGenerateReport() {
    ...
    const nextHistory = mergeReportHistory({
      history: state.reportHistory,
      current: state.reportSnapshot,
      next: generated.snapshot,
    });
    onChange({
      reportSnapshot: generated.snapshot,
      reportHistory: nextHistory,
