...
const SUPPORT_KIND_ORDER: Record<DerivationSourceProfile['inputProfile'], SourceParagraphKind[]> = {
  ...
  'mixed-process-document': ['issue', 'knowledge', 'measure', 'governance', 'tableLike', 'commentary'],
  'signal-heavy-document': ['issue', 'knowledge', 'measure', 'governance', 'tableLike', 'commentary'],
