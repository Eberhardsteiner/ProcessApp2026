...
const ROLE_CANONICALS: Array<{ key: string; label: string; patterns: RegExp[] }> = [
  ...
  { key: 'role:qualitaetsmanagement', label: 'Qualitätsmanagement', patterns: [/qualit[aä]tsmanagement/i, /\bqm\b/i, /\bqs\b/i, /qualit[aä]tssicherung/i, /quality management/i] },
  ...
  { key: 'role:finanzbuchhaltung', label: 'Finanzbuchhaltung', patterns: [/finanzbuchhaltung/i, /debitorenbuchhaltung/i, /kreditorenbuchhaltung/i, /finance/i] },
  { key: 'role:stammdatenmanagement', label: 'Stammdatenmanagement', patterns: [/stammdatenmanagement/i, /master data/i] },
  { key: 'role:compliance', label: 'Compliance', patterns: [/compliance/i, /regulatorik/i] },
];
...
const SYSTEM_CANONICALS: Array<{ key: string; label: string; patterns: RegExp[] }> = [
  ...
  { key: 'system:workflow', label: 'Workflow', patterns: [/workflow/i, /freigabeworkflow/i] },
  { key: 'system:mdm', label: 'MDM', patterns: [/\bmdm\b/i, /master data/i] },
  { key: 'system:rechnungsworkflow', label: 'Rechnungsworkflow', patterns: [/rechnungsworkflow/i, /invoice workflow/i] },
];
